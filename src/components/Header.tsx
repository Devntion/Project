  ...
  return (
    <>
      ...
      <header className="flex items-center justify-between border-b-2 border-border-separator pb-4 mb-6">
        <img src={TopImage} alt="SemRepo Logo" className="h-20" />
        <div className="flex-1 text-center">
          <h1 className="text-3xl font-bold text-text-primary">
            {mainMetadata.title}
          </h1>
          <p className="mt-2 text-text-primary">
            Semantic Repository Ontology
          </p>
        </div>
      </header>
            ...
            <ul className="space-y-0 ml-5">
              {creators.map((creator, index) => (
                <li key={index} className="text-primary">
                  <a href={creator.link} target="_blank" rel="noopener noreferrer" className="hover:underline">
              ...
              <ul className="space-y-0 ml-5">
                {contributors.map((contributor, index) => (
                  <li key={index} className="text-gray-300">
                    <a href={contributor.link} target="_blank" rel="noopener noreferrer" className="hover:underline">
