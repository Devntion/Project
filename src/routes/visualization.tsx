...
function RouteComponent() {
  ...
  useEffect(() => {
    ...
    script.src = '/src/assets/visualize.js'
    script.async = true
  ...
  return (
    <div ref={containerRef} className="p-6 max-w-7xl mx-auto bg-white rounded-lg shadow-lg">
      <h2 className="text-3xl font-bold mb-6 text-center text-blue-700 border-b pb-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
        <div className="p-3 bg-gray-50 rounded-lg shadow-sm">
          <label htmlFor="xColumn" className="block text-sm font-medium text-gray-700 mb-1">X-Axis:</label>
          <select id="xColumn" className="w-full p-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"></select>
        </div>

        <div className="p-3 bg-gray-50 rounded-lg shadow-sm">
          <label htmlFor="yColumn" className="block text-sm font-medium text-gray-700 mb-1">Y-Axis:</label>
          <select id="yColumn" className="w-full p-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"></select>
        </div>

        <div className="p-3 bg-gray-50 rounded-lg shadow-sm">
          <label htmlFor="zColumn" className="block text-sm font-medium text-gray-700 mb-1">Z-Axis:</label>
          <select id="zColumn" className="w-full p-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"></select>
        </div>

        <div className="p-3 bg-gray-50 rounded-lg shadow-sm">
          <label htmlFor="colorColumn" className="block text-sm font-medium text-gray-700 mb-1">Color By:</label>
          <select id="colorColumn" className="w-full p-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"></select>
        </div>

        <div className="p-3 bg-gray-50 rounded-lg shadow-sm">
          <label htmlFor="chartType" className="block text-sm font-medium text-gray-700 mb-1">Chart Type:</label>
          <select id="chartType" className="w-full p-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
        ...
        <div className="p-3 bg-gray-50 rounded-lg shadow-sm">
          <label htmlFor="groupByColumn" className="block text-sm font-medium text-gray-700 mb-1">Group By:</label>
          <select id="groupByColumn" className="w-full p-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
            <option value="">None</option>
          </select>
        </div>

        <div className="p-3 bg-gray-50 rounded-lg shadow-sm">
          <label htmlFor="aggregationType" className="block text-sm font-medium text-gray-700 mb-1">Aggregation:</label>
          <select id="aggregationType" className="w-full p-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
      ...
      <div 
        id="chart" 
        className="w-full h-[600px] border border-gray-200 rounded-lg shadow-md bg-white p-2"
      ></div>
